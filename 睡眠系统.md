...
# 第一次请求
{
 	"task_id": "", # 第一次请求task_id为空
    "sleep_data": {"eeg_data":[[],[],[]],"posture_data":[],"brain_data":[]},
    "status": "start"
}
# 持续
{
...
- `task_id`：任务id（第一次请求，后端返回）
- `sleep_data`:  硬件数据，eeg数据长度[[30*512],[ 30 * 152]....]，30个512长度数据，30秒
- `status`:  状态
...
```json
{
    "code": 200,
    "msg": 1,
    'datainfo': {'task_id': '15200802947_dde148f2-3e39-455c-be2d-75f839afc7b8'}
}
